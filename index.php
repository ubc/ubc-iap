  ...
  <section class="bg-white">
    <div class="container py-5">
      ...
      <?php while(have_posts()): the_post(); ?>
        <?php $author_name = ( function_exists( 'coauthors' ) ) ? coauthors( null, null, null, false ) : get_the_author_meta( 'display_name' ); ?>
        <div class="row mb-5">
          <div class="col-md-4">
          ...
          <div class="col-md-8">
            ...
            <p class="mb-3 small">By <span><?php echo esc_html( $author_name ); ?></span> on <span><?php echo get_the_date( 'F jS, Y' ); ?></span></p>
