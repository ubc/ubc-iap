  ...
  <section class="bg-beige">
    <div class="clip-ellipse">
      <div class="text-white">
        <div style="background:#00B6EA">
          <div class="container position-relative pt-md-5 pt-lg-8">
            <span class="vertical"><h3 class="mb-0 text-whitney text-uppercase"><?php echo esc_html(carbon_get_the_post_meta( 'crb_vertical_text_1' )) ?></h3></span>
            <div class="row mt-5">
              <div class="col-md-5 pl-md-5 pl-lg-6 pl-xl-7 mb-3">
                <figure class="img-rounded--text blue">
                  <div class="line-diagonal-right p-3"><h3 class="mb-0 text-whitney"><?php echo esc_html(carbon_get_the_post_meta('crb_main_bubble_heading')) ?></h3></div>
                </figure>
              </div>
              <div class="col-md-6 offset-md-1">
                ...
                <?php echo get_template_part('partials/bubble', '', array(
            ...
            <?php foreach(carbon_get_the_post_meta('crb_bubble_1_rows') as $row): ?>
              <?php echo get_template_part('partials/row', 'bubble', array(
        ...
        <div style="background:#00A8E7">
          <div class="container position-relative">
            <span class="vertical"><h3 class="mb-0 text-whitney text-uppercase"><?php echo esc_html(carbon_get_the_post_meta( 'crb_vertical_text_2' )) ?></h3></span>
